...
namespace Blog.Controllers
{
    ...
    public class ArticleAPIController : ControllerBase
    {
        ...
        /// Data / Request Body: {"ArticleTitle":"My encounter in mexico","ArticleBody":"I had a great more time"}
        /// -> 
        /// "12"
        /// </example>
        ...
        /// <summary>
        /// This endpoint receives article information and updates the article in the database
        /// </summary>
        /// <returns>
        /// The article resource which we have just updated
        /// </returns>
        /// <param name="ArticleId">The primary key of the article to update</param>
        /// <param name="UpdatedArticle">The values to update the article to</param>
        /// <example>
        /// PUT: ArticleAPI/UpdateArticle/5
        /// Request Header: Content-Type: application/json
        /// Request Body:
        /// {"ArticleTitle":"My grand adventure","ArticleBody":"I had a fun drink with a little umbrella in it"}
        /// ->
        /// {"ArticleId":"5","ArticleTitle":"My grand adventure","ArticleBody":"I had a fun drink with a little umbrella in it","NumComments":4}
        /// </example>
        [HttpPut(template: "UpdateArticle/{ArticleId}")]
        public Article UpdateArticle(int ArticleId, [FromBody] Article UpdatedArticle)
        {
            //Debug.WriteLine($"The article Title is : {UpdatedArticle.ArticleTitle}");

            string query = "update articles set articletitle=@title, articlebody=@body where articleid=@id";
            ...
            using (MySqlConnection Connection = _context.AccessDatabase())
            {
                ...
                Command.Parameters.AddWithValue("@title", UpdatedArticle.ArticleTitle);
                Command.Parameters.AddWithValue("@body", UpdatedArticle.ArticleBody);
                Command.Parameters.AddWithValue("@id", ArticleId);
                Command.CommandText = query;
